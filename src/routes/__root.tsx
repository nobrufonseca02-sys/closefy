...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Closefy" },
      { name: "description", content: "Mini-CRM para controle de leads high ticket: Kanban, tags e feedbacks de reunião." },
      { property: "og:title", content: "Closefy" },
      { property: "og:description", content: "Mini-CRM para controle de leads high ticket: Kanban, tags e feedbacks de reunião." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Closefy" },
      { name: "twitter:description", content: "Mini-CRM para controle de leads high ticket: Kanban, tags e feedbacks de reunião." },
